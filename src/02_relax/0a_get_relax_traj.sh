...
# 444 (LBFGS)
rsync  -Pr huangj4@triton.aalto.fi:/scratch/phys/project/sin/Jie/Github/cp2kTest/PreviousOpt_Morestep/cluster_444_3000_scratch_L_1208/MAPbI3-pos-1.xyz cluster_444/
