...
do
    ...
    extractLast ${relaxPath}/level${vacancyLevel}/MAPbI3-pos-1.xyz > MAPbI3-pos-1-temp.xyz
    # This script will read a xyz file then remove water molecules, and output a xyz file
    ./removeWater.py MAPbI3-pos-1-temp.xyz # && rm MAPbI3-pos-1-temp.xyz
    cp waterRemoved_xyz_file.xyz  ${basePath}/level${vacancyLevel}/MAPbI3-pos-last.xyz
